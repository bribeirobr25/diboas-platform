...
const NAMESPACE_LOADERS: Record<SupportedLocale, NamespaceLoaders> = {
  en: {
    ...
    marketing: () => import(/* webpackChunkName: "i18n-en-marketing" */ '../translations/en/marketing.json').then(resolveDefault),
  ...
  de: {
    ...
    marketing: () => import(/* webpackChunkName: "i18n-de-marketing" */ '../translations/de/marketing.json').then(resolveDefault),
  ...
  es: {
    ...
    marketing: () => import(/* webpackChunkName: "i18n-es-marketing" */ '../translations/es/marketing.json').then(resolveDefault),
  ...
  'pt-BR': {
    ...
    marketing: () => import(/* webpackChunkName: "i18n-pt-BR-marketing" */ '../translations/pt-BR/marketing.json').then(resolveDefault),
