...
const NAMESPACE_LOADERS: Record<SupportedLocale, NamespaceLoaders> = {
  en: {
    ...
    'learn': () => import(/* webpackChunkName: "i18n-en-learn" */ '../translations/en/learn.json').then(resolveDefault),
    'learn-compound-interest': () => import(/* webpackChunkName: "i18n-en-learn-compound-interest" */ '../translations/en/learn-compound-interest.json').then(resolveDefault),
    'tools-shared': () => import(/* webpackChunkName: "i18n-en-tools-shared" */ '../translations/en/tools-shared.json').then(resolveDefault),
    'tools-compound-interest': () => import(/* webpackChunkName: "i18n-en-tools-compound-interest" */ '../translations/en/tools-compound-interest.json').then(resolveDefault),
  ...
  de: {
    ...
    'learn': () => import(/* webpackChunkName: "i18n-de-learn" */ '../translations/de/learn.json').then(resolveDefault),
    'learn-compound-interest': () => import(/* webpackChunkName: "i18n-de-learn-compound-interest" */ '../translations/de/learn-compound-interest.json').then(resolveDefault),
    'tools-shared': () => import(/* webpackChunkName: "i18n-de-tools-shared" */ '../translations/de/tools-shared.json').then(resolveDefault),
    'tools-compound-interest': () => import(/* webpackChunkName: "i18n-de-tools-compound-interest" */ '../translations/de/tools-compound-interest.json').then(resolveDefault),
  ...
  es: {
    ...
    'learn': () => import(/* webpackChunkName: "i18n-es-learn" */ '../translations/es/learn.json').then(resolveDefault),
    'learn-compound-interest': () => import(/* webpackChunkName: "i18n-es-learn-compound-interest" */ '../translations/es/learn-compound-interest.json').then(resolveDefault),
    'tools-shared': () => import(/* webpackChunkName: "i18n-es-tools-shared" */ '../translations/es/tools-shared.json').then(resolveDefault),
    'tools-compound-interest': () => import(/* webpackChunkName: "i18n-es-tools-compound-interest" */ '../translations/es/tools-compound-interest.json').then(resolveDefault),
  ...
  'pt-BR': {
    ...
    'learn': () => import(/* webpackChunkName: "i18n-pt-BR-learn" */ '../translations/pt-BR/learn.json').then(resolveDefault),
    'learn-compound-interest': () => import(/* webpackChunkName: "i18n-pt-BR-learn-compound-interest" */ '../translations/pt-BR/learn-compound-interest.json').then(resolveDefault),
    'tools-shared': () => import(/* webpackChunkName: "i18n-pt-BR-tools-shared" */ '../translations/pt-BR/tools-shared.json').then(resolveDefault),
    'tools-compound-interest': () => import(/* webpackChunkName: "i18n-pt-BR-tools-compound-interest" */ '../translations/pt-BR/tools-compound-interest.json').then(resolveDefault),
