...
- **Legal/counsel round:** counsel brief + the CLO "if I were your lawyer" answers → founder relayed EU/US/BR **lawyer feedback** (cleared under covenants; *licensed-opinion status TBC — B3 formal opinions remain the record-gate*). CLO rulings R-1…R-6 landed (R-5 relaxed: **server-side financial profile OK under 5 non-severable conditions**; anonymous-play-first mandatory; 18+ self-attestation; deletion cascade; consent versioning; **four unbundled opt-ins**). **Best-practice ToS/Privacy/M2 DRAFTS in `docs/sandbox-app/legal-drafts/` ×4 langs** (for counsel to red-line, NOT legal advice).
