...
function simulatePoupanca() {
  return {
    selic_14_50: derivePoupancaRate(14.50, 0),
...
const outPath = outArg !== -1 ? process.argv[outArg + 1] : path.join(__dirname, 'tools-simulator-out.json');

const baseline = {
  generatedAt: new Date().toISOString(),
  schema: 'tools-simulator-v1',
  retirement: LOCALES.flatMap((loc) => [
    { variant: 'default', ...simulateRetirement(loc, loc === 'pt-BR' ? 2000 : loc === 'en' ? 500 : 400, 25) },
    { variant: 'modA_double_contrib', ...simulateRetirement(loc, loc === 'pt-BR' ? 4000 : loc === 'en' ? 1000 : 800, 25) },
    { variant: 'modB_longer_horizon', ...simulateRetirement(loc, loc === 'pt-BR' ? 2000 : loc === 'en' ? 500 : 400, 35) },
  ]),
  compoundInterest: LOCALES.flatMap((loc) => [
    { variant: 'default', ...simulateCompoundInterest(loc, loc === 'pt-BR' ? 760 : loc === 'en' ? 152 : 91, 12) },
  ]),
  idleCash: LOCALES.flatMap((loc) => [
    { variant: 'default', ...simulateIdleCash(loc, loc === 'pt-BR' ? 500000 : loc === 'en' ? 100000 : 80000, 3) },
  ]),
