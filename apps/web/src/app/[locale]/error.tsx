...
/**
 * Locale Route Group Error Boundary
 *
 * Catches errors at the [locale] level before they propagate to the root.
 * Uses inline styles since CSS/Tailwind may not be loaded during error recovery.
 */
...
export default function LocaleError({ error, reset }: ErrorProps) {
  useEffect(() => {
    errorReportingService.captureException(error, {
      tags: {
        errorBoundary: 'locale-route-group',
        digest: error.digest,
      },
      level: 'error',
    });
