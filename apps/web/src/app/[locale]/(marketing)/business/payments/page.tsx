...
export default async function BusinessPaymentsPage({ params }: LocalePageProps) {
  ...
  // Load page-specific namespaces (business/payments + shared: home for StickyFeaturesNav, faq for FAQAccordion)
  const pageMessages = await loadPageNamespaces(locale, ['business/payments', 'home', 'faq']);
  ...
  return (
    ...
    <>
      ...
      <main className="main-page-wrapper">
        ...
        <SectionErrorBoundary
          sectionId="feature-showcase-businessPayments"
          sectionType="FeatureShowcase"
          enableReporting={true}
          context={{ page: 'businessPayments' }}
        >
          <FeatureShowcase
            config={FEATURE_SHOWCASE_PAGE_CONFIGS.businessPayments}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
        ...
        <SectionErrorBoundary
          sectionId="sticky-features-nav-businessPayments"
          sectionType="StickyFeaturesNav"
          enableReporting={true}
          context={{ page: 'businessPayments' }}
        >
          <StickyFeaturesNav
            config={STICKY_FEATURES_NAV_PAGE_CONFIGS.businessPayments}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
        ...
        <SectionErrorBoundary
          sectionId="faq-accordion-businessPayments"
          sectionType="FAQAccordion"
          enableReporting={true}
          context={{ page: 'businessPayments' }}
        >
          <FAQAccordion
            config={FAQ_ACCORDION_PAGE_CONFIGS.businessPayments!}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
