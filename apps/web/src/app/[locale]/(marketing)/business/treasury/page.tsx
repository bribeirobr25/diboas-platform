...
export default async function BusinessTreasuryPage({ params }: LocalePageProps) {
  ...
  // Load page-specific namespaces (business/treasury + shared: home for StickyFeaturesNav, faq for FAQAccordion)
  const pageMessages = await loadPageNamespaces(locale, ['business/treasury', 'home', 'faq']);
  ...
  return (
    ...
    <>
      ...
      <main className="main-page-wrapper">
        ...
        <SectionErrorBoundary
          sectionId="feature-showcase-businessTreasury"
          sectionType="FeatureShowcase"
          enableReporting={true}
          context={{ page: 'businessTreasury' }}
        >
          <FeatureShowcase
            config={FEATURE_SHOWCASE_PAGE_CONFIGS.businessTreasury}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
        ...
        <SectionErrorBoundary
          sectionId="faq-accordion-businessTreasury"
          sectionType="FAQAccordion"
          enableReporting={true}
          context={{ page: 'businessTreasury' }}
        >
          <FAQAccordion
            config={FAQ_ACCORDION_PAGE_CONFIGS.businessTreasury!}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
