...
export default async function SecuritySafetyGuidePage({ params }: LocalePageProps) {
  ...
  return (
    ...
    <>
      ...
      <main className="main-page-wrapper">
        ...
        <SectionErrorBoundary
          sectionId="feature-showcase-securitySafetyGuide"
          sectionType="FeatureShowcase"
          enableReporting={true}
          context={{ page: 'securitySafetyGuide' }}
        >
          <FeatureShowcase
            config={FEATURE_SHOWCASE_PAGE_CONFIGS.securitySafetyGuide}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
        ...
        <SectionErrorBoundary
          sectionId="sticky-features-nav-securitySafetyGuide"
          sectionType="StickyFeaturesNav"
          enableReporting={true}
          context={{ page: 'securitySafetyGuide' }}
        >
          <StickyFeaturesNav
            config={STICKY_FEATURES_NAV_PAGE_CONFIGS.securitySafetyGuide}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
        ...
        <SectionErrorBoundary
          sectionId="faq-accordion-securitySafetyGuide"
          sectionType="FAQAccordion"
          enableReporting={true}
          context={{ page: 'securitySafetyGuide' }}
        >
          <FAQAccordion
            config={FAQ_ACCORDION_PAGE_CONFIGS.securitySafetyGuide!}
            enableAnalytics={true}
          />
        </SectionErrorBoundary>
