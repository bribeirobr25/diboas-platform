...
export const ANCHOR_PRICES: readonly AssetAnchor[] = [
  ...
  { asset: 'BTC', year: 2010, monthIndicative: 7, price: 0.07, currency: 'USD', confidence: 'MEDIUM', source: 'Mt.Gox launch, research midpoint' },
  { asset: 'BTC', year: 2016, monthIndicative: 3, price: 416.73, currency: 'USD', confidence: 'HIGH', source: 'CoinGecko via research Part 2' },
  { asset: 'BTC', year: 2026, monthIndicative: 5, price: 80000, currency: 'USD', confidence: 'HIGH', source: 'mid-May 2026 spot' },
  // S&P 500 (price index — Part 1 anchor reconstructs TR via dividend series)
  { asset: 'SP500', year: 2010, monthIndicative: 7, price: 1030, currency: 'USD', confidence: 'HIGH', source: 'Yahoo Finance ^GSPC, research Part 1' },
  { asset: 'SP500', year: 2016, monthIndicative: 3, price: 2060, currency: 'USD', confidence: 'HIGH', source: 'Yahoo Finance ^GSPC, research Part 2' },
  { asset: 'SP500', year: 2026, monthIndicative: 5, price: 7400, currency: 'USD', confidence: 'MEDIUM', source: 'mid-May 2026 estimate' },
  // QQQ (split-adjusted)
  { asset: 'QQQ', year: 2010, monthIndicative: 7, price: 45.5, currency: 'USD', confidence: 'HIGH', source: 'Yahoo Finance, research Part 1' },
  { asset: 'QQQ', year: 2016, monthIndicative: 3, price: 108, currency: 'USD', confidence: 'HIGH', source: 'Yahoo Finance, research Part 2' },
  { asset: 'QQQ', year: 2026, monthIndicative: 5, price: 711, currency: 'USD', confidence: 'MEDIUM', source: 'mid-May 2026 estimate' },
  // MSCI World (gross USD)
  { asset: 'MSCI_WORLD', year: 2010, monthIndicative: 7, price: 1180, currency: 'USD', confidence: 'HIGH', source: 'MSCI, research Part 1' },
  { asset: 'MSCI_WORLD', year: 2016, monthIndicative: 3, price: 1610, currency: 'USD', confidence: 'HIGH', source: 'MSCI, research Part 2' },
  { asset: 'MSCI_WORLD', year: 2026, monthIndicative: 5, price: 5540, currency: 'USD', confidence: 'MEDIUM', source: 'mid-May 2026 estimate' },
  // Gold (spot $/oz)
  { asset: 'GOLD', year: 2010, monthIndicative: 7, price: 1200, currency: 'USD', confidence: 'HIGH', source: 'LBMA, research Part 1' },
  { asset: 'GOLD', year: 2016, monthIndicative: 3, price: 1235, currency: 'USD', confidence: 'HIGH', source: 'LBMA, research Part 2' },
  { asset: 'GOLD', year: 2026, monthIndicative: 5, price: 4700, currency: 'USD', confidence: 'MEDIUM', source: 'mid-May 2026 spot' },
  // TLT (20+ Year Treasury ETF, TR-adjusted)
  { asset: 'TLT', year: 2010, monthIndicative: 7, price: 98, currency: 'USD', confidence: 'HIGH', source: 'iShares, research Part 1' },
  { asset: 'TLT', year: 2016, monthIndicative: 3, price: 94, currency: 'USD', confidence: 'HIGH', source: 'iShares, research Part 2' },
  { asset: 'TLT', year: 2026, monthIndicative: 5, price: 85, currency: 'USD', confidence: 'MEDIUM', source: 'mid-May 2026 effective' },
  // Ibovespa (BRL, TR)
  { asset: 'IBOVESPA', year: 2010, monthIndicative: 7, price: 67500, currency: 'BRL', confidence: 'HIGH', source: 'B3, research Part 1' },
  { asset: 'IBOVESPA', year: 2016, monthIndicative: 3, price: 50055, currency: 'BRL', confidence: 'HIGH', source: 'B3, research Part 2' },
  { asset: 'IBOVESPA', year: 2026, monthIndicative: 5, price: 177000, currency: 'BRL', confidence: 'MEDIUM', source: 'mid-May 2026 estimate' },
  // DAX (TR, EUR)
  { asset: 'DAX', year: 2010, monthIndicative: 7, price: 6100, currency: 'EUR', confidence: 'HIGH', source: 'Deutsche Börse, research Part 1' },
  { asset: 'DAX', year: 2016, monthIndicative: 3, price: 9966, currency: 'EUR', confidence: 'HIGH', source: 'Deutsche Börse, research Part 2' },
  { asset: 'DAX', year: 2026, monthIndicative: 5, price: 24000, currency: 'EUR', confidence: 'MEDIUM', source: 'mid-May 2026 estimate' },
] as const;
