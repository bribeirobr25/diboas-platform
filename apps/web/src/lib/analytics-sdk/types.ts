...
export interface RegimeSummary {
  ...
  detailed: string;
  /**
   * Plain-language "grandmother layer" summary (P3, 2026-07-11): jargon-free,
   * one-feeling-per-cycle copy generated by the market-refresh Stage-4
   * template library. Optional/back-compat — the research-memo `detailed`
   * voice stays and renders beneath it. Contract extension logged in the
   * doc 13 §23 drift-log.
   */
  plain?: string;
