...
export const SEO_DEFAULTS = {
  ...
  siteUrl:
    ...
    `https://${process.env.NEXT_PUBLIC_SITE_DOMAIN || 'diboas.com'}`,
  ...
  organization: {
    ...
    sameAs: [BRAND_CONFIG.TWITTER_URL, BRAND_CONFIG.LINKEDIN_URL, BRAND_CONFIG.GITHUB_URL],
  },
} as const;
...
export const PAGE_SEO_CONFIG = {
  home: {
    ...
    description:
      'See what $1,000 becomes in a year when you have access to fair opportunities. Start from $5.',
    keywords: ['goal-driven investing', 'wealth building', 'earn interest on savings'],
  },
  about: {
    title: 'About diBoaS - Our Mission and Vision',
    description:
      'Built because one grandmother deserved better. Now everyone does. Free transfers, real growth, starting at $5.',
  ...
  business: {
    ...
    description:
      'Stop losing 2-3% on every card payment. Put idle cash to work. Free payments, instant transfers.',
  ...
  demo: {
    ...
    description:
      'Try the diBoaS platform with our interactive demo and see your financial potential.',
  ...
  protocols: {
    ...
    description:
      'See exactly where your money works. Full transparency about every system we use and why we trust them.',
    keywords: ['protocol transparency', 'where money works', 'audited financial systems'],
  },
  security: {
    title: 'Security - How We Protect Your Assets',
    description:
      'Your money stays in your wallet, not ours. Non-custodial architecture, advanced key security, and 24/7 monitoring.',
  ...
  strategies: {
    ...
    description:
      'Different goals. Different risk levels. Find the approach that matches where you are and where you want to be.',
  ...
  'tools/compound-interest': {
    ...
    description:
      'Free compound interest calculator. Pick an amount, a cadence, and a timeframe. See bank vs diBoaS side-by-side.',
    keywords: ['compound interest calculator', 'savings calculator', 'investment growth'],
  },
  'tools/retirement': {
    title: 'Retirement Calculator',
    description:
      'See what your monthly savings could become at 65. Free retirement calculator from diBoaS.',
    keywords: ['retirement calculator', 'retirement savings', 'retirement planning'],
  },
  'tools/emergency-fund': {
    title: 'Emergency Fund Calculator',
    description:
      'See how fast you can save 6 months of expenses. Free emergency fund calculator from diBoaS.',
    keywords: ['emergency fund calculator', 'savings goal', 'rainy day fund'],
  },
  'tools/goal-savings': {
    title: 'Goal-Based Savings Calculator',
    description:
      'Plan toward any number. Pick a goal and timeframe; see bank vs diBoaS side-by-side.',
  ...
  'tools/time-to-target': {
    ...
    description:
      'When will you reach your savings goal? See years to target across bank, conservative, historical, and optimistic yields.',
  ...
  'tools/currency-depreciation': {
    ...
    description:
      'See what your local currency really earns. Compare cash, bank, and digital dollar at historical rate (10%).',
    keywords: [
      'currency depreciation calculator',
      'inflation hedge',
      'local currency vs digital dollar',
    ],
  },
  ...
  'tools/card-fees': {
    ...
    description:
      'Free B2B card fee savings calculator. See how much your business pays processors per year.',
    keywords: ['card processing fee calculator', 'business card fees', 'merchant fee calculator'],
  },
  'tools/idle-cash': {
    title: 'Idle Cash Yield Calculator',
    description:
      'Free B2B idle cash yield calculator. Compare what your business cash earns at the bank vs at diBoaS.',
