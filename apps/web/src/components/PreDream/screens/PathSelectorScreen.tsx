...
const PATH_STYLES: Record<PreDreamPath, { bg: string; text: string; border: string; iconBg: string }> = {
  safety: { bg: styles.pathSafetyBg, text: styles.pathSafetyText, border: styles.pathSafetyBorder, iconBg: styles.pathSafetyIconBg },
  balance: { bg: styles.pathBalanceBg, text: styles.pathBalanceText, border: styles.pathBalanceBorder, iconBg: styles.pathBalanceIconBg },
  growth: { bg: styles.pathGrowthBg, text: styles.pathGrowthText, border: styles.pathGrowthBorder, iconBg: styles.pathGrowthIconBg },
};
