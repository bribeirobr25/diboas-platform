...
export function ShareDreamSection({ result, difference: differenceProp }: ShareDreamSectionProps) {
  ...
  const getShareText = useCallback((): string => {
    ...
    return intl.formatMessage({ id: 'preDream.results.shareText' }, { start, end, difference });
        ...
        switch (platform) {
          ...
          case 'linkedin':
            try {
              ...
              Logger.warn('Clipboard write failed for LinkedIn share', {
