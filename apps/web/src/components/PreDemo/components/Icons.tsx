...
export function AlertIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" className={styles.alertIconInline}>
...
export function MetaMaskIcon({ size = 20 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size}>
      ...
      <path fill="#E27625" d="M3.5 2l7.9 6.1L10 4.5zm14.1 14.5l-2.1 3.2 4.5 1.2 1.3-4.4zm-16.3 0l1.3 4.4 4.5-1.2-2.1-3.2z" />
      <path fill="#E27625" d="M7.3 10.5l-1.8 2.7 4.5.2-.2-4.8zm9.4 0l-2.6-2-0.1 4.9 4.5-.2zm-9.3 8.2l2.7-1.3-2.3-1.8zm5.5-1.3l2.7 1.3-.4-3.1z" />
      ...
      <path fill="#CC6228" d="M8.4 18.7l.4-3.2-2.5.1zm6.8-3.2l.4 3.2 2.1-3.1zm2.3-4.8l-4.5.2.4 2.1.6-1.4 1.6.7zm-10.8 1.6l1.6-.7.6 1.4.4-2.1-4.5-.2z" />
      <path fill="#E27525" d="M5.5 10.7l1.9 3.7-.1-1.8zm11.1 1.9l-.1 1.8 1.9-3.7zm-6.6-.3l-.4 2.1.5 2.6.1-3.5zm3 0l-.2 1.2.1 3.5.5-2.6z" />
      <path fill="#F5841F" d="M13.1 14.8l-.5 2.6.4.3 2.3-1.8.1-1.8zm-4.4-.7l.1 1.8 2.3 1.8.4-.3-.5-2.6z" />
      <path fill="#C0AC9D" d="M13.2 19.8v-.7l-.2-.2h-2l-.2.2v.7l-2.5-1.1.9.7 1.8 1.2h2.1l1.8-1.2.9-.7z" />
      <path fill="#161616" d="M12.9 17.4l-.4-.3h-1l-.4.3-.2 1.7.2-.2h2l.2.2z" />
      <path fill="#763E1A" d="M20.8 8.5l.7-3.3L20.5 2l-7.6 5.6 2.9 2.5 4.1 1.2.9-1.1-.4-.3.6-.6-.5-.4.6-.5zm-18.3-3.3l.7 3.3-.4.3.6.5-.5.4.6.6-.4.3.9 1.1 4.1-1.2L11.1 7.6 3.5 2z" />
      <path fill="#F5841F" d="M19.9 11.3l-4.1-1.2 1.2 1.9-1.9 3.7 2.6-.1h3.8zm-15.8-1.2l-4.1 1.2 1.5 4.4h3.8l2.6.1-1.9-3.7zm6.9 2.2l.3-4.7 1.2-3.3h-5.4l1.2 3.3.3 4.7.1 1.2v3.4h1l.1-3.4z" />
    </svg>
  );
}
