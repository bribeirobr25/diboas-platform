  ...
  if (state.transactions.length === 0) {
    return (
      <div className={styles.activityFeed}>
        <h3 className={styles.activityTitle}>{t('preDemo.home.activity')}</h3>
        <div className={styles.activityEmpty}>
          ...
          <p className={styles.activityEmptyText}>{t('preDemo.home.noActivity')}</p>
          <p className={styles.activityEmptySubtext}>{t('preDemo.home.noActivitySubtitle')}</p>
        </div>
      </div>
    );
  }
        ...
        {state.transactions.map((tx) => (
          <div key={tx.id} className={styles.activityItem}>
            ...
            <div className={styles.activityDetails}>
              <span className={styles.activityDescription}>{tx.description}</span>
