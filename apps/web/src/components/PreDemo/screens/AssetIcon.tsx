  ...
  if (symbol === 'SOL') {
    return (
      <div
        ...
        style={{ background: `linear-gradient(135deg, ${CRYPTO_COLORS.SOL}, #14F195)` }}
      >
        <svg viewBox="0 0 24 24" width="18" height="18">
          <path
            fill="white"
            d="M4.5 16.5l2.3-2.3c.1-.1.3-.2.4-.2h12.3c.3 0 .4.3.2.5l-2.3 2.3c-.1.1-.3.2-.4.2H4.7c-.3 0-.4-.3-.2-.5zm2.3-5.3c.1-.1.3-.2.4-.2h12.3c.3 0 .4.3.2.5l-2.3 2.3c-.1.1-.3.2-.4.2H4.7c-.3 0-.4-.3-.2-.5l2.3-2.3zm12.5-4l-2.3 2.3c-.1.1-.3.2-.4.2H4.3c-.3 0-.4-.3-.2-.5l2.3-2.3c.1-.1.3-.2.4-.2h12.3c.3 0 .4.3.2.5z"
          />
        </svg>
      </div>
    );
    ...
    return (
      <div className={styles.assetIcon} style={{ background: CRYPTO_COLORS.SUI }}>
        <svg viewBox="0 0 24 24" width="18" height="18">
          <path
            fill="white"
            d="M12 6c-2.5 0-4.5 2-4.5 4.5 0 1.5.7 2.8 1.8 3.6l2.2 2.2c.3.3.7.3 1 0l2.2-2.2c1.1-.8 1.8-2.1 1.8-3.6C16.5 8 14.5 6 12 6zm0 7c-1.4 0-2.5-1.1-2.5-2.5S10.6 8 12 8s2.5 1.1 2.5 2.5S13.4 13 12 13z"
          />
        </svg>
      </div>
    );
