 ...
 * white (--sb-surface-primary) with a hairline for definition on the warm off-white page;
 * `tint` = the faint accent wash (--sb-surface-accent) for an emphasized surface (e.g.
