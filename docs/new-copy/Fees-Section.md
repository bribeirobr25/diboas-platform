# diBoaS Fees Section — Landing Page Copy

**Version:** 1.1  
**Date:** February 22, 2026  
**Status:** Advisory Board Approved  
**Languages:** EN (US), DE (EU), PT-BR (Brazil), ES (Spanish)
...
| Element | Treatment |
|---------|-----------|
| **FREE / GRATIS / GRÁTIS / GRATUITO** | Bold + Green (#10B981) |
| **"instant" / "sofort" / "na mesma hora" / "instantáneo"** | Same row, regular weight |
| **X× cheaper** | Bold, accent color recommended |
| **Example line** | Slightly smaller font, italicized |
| **Footer "No..." statements** | Regular weight, centered |

---

## 🇺🇸 English (US) Version

### Your money. Your rules. No surprises.

*See exactly what you pay. Here's everything — no fine print.*

| What you do | With diBoaS | Typical apps | The difference |
|-------------|-------------|--------------|----------------|
...
| **Cash out** | 0.48% — Instant | 1–3% + delays | **2–6× cheaper** |
...
### Dein Geld. Deine Regeln. Keine Überraschungen.

*Sieh genau, was du zahlst. Hier ist alles — kein Kleingedrucktes.*

| Was du tust | Mit diBoaS | Andere Apps | Der Unterschied |
|-------------|------------|-------------|-----------------|
...
| **Auszahlen** | 0,48% — Sofort | 1–3% + Wartezeit | **2–6× günstiger** |
...
### Seu dinheiro. Suas regras. Sem surpresas.

*Veja exatamente o que você paga. Aqui está tudo — sem letras miúdas.*

| O que você faz | Com diBoaS | Apps comuns | A diferença |
|----------------|------------|-------------|-------------|
...
| **Sacar** | 0,48% — Na hora | 1–3% + demora | **2–6× mais barato** |
...
### Tu dinero. Tus reglas. Sin sorpresas.

*Mira exactamente lo que pagas. Aquí está todo — sin letra pequeña.*

| Qué haces | Con diBoaS | Apps típicas | La diferencia |
|-----------|------------|--------------|---------------|
...
| **Retirar** | 0,48% — Instantáneo | 1–3% + demoras | **2–6× más barato** |
...
### Fee Structure Reference (Canonical)

| Action | Fee Type | Rate | Floor | Cap |
|--------|----------|------|-------|-----|
...
| Swap | Free | 0% | — | — |
| Bridge | Free | 0% | — | — |
| Start Strategy | Free | 0% | — | — |
| Stop Strategy | Exec | 0.39% | $0.25 | $25 |

### Locale-Specific Fee Floors (Recommended)
...
Fee comparisons based on research conducted February 2026:

- **US:** Coinbase, Cash App, PayPal, Venmo, Robinhood, Chase, Bank of America
- **EU:** Revolut, N26, Wise, Trade Republic, Deutsche Bank, BNP Paribas
- **Brazil:** Nubank, Mercado Pago, PicPay, Banco Inter, C6 Bank, Itaú, Bradesco
...
|---------|------|---------|
| 1.0 | Feb 21, 2026 | Initial version with EN, DE, PT-BR, ES |
| 1.1 | Feb 22, 2026 | Updated to match live implementation: added Gold* (pending CLO), "+ spreads" in competitor column, "0.39% when you stop" for strategies, "worldwide/weltweit/mundial" for send, "Instant/Sofort/Na hora/Instantáneo" for cash out, "You keep everything" for swap |
