...
| **Fees / any figure**          | `docs/full-view/FEES.md` — the ONLY source. 0.48% ramp (no caps — B2C and B2B, FE-1 2026-08-03) · 0.39% exit ($0.25 floor, no cap) · min add $10/€10/R$20 · invest/send/swap FREE. There is no "cost of funds," no "platform fee," no "success fee."                                                                                                                                                                                                                                                              |
...
| **Positioning line**           | "Your side-pocket for wealth creation — goal-driven, powered by the digital dollar." No invented alternative taglines. **(F-R3, 2026-08-29: this is the LEGACY-RUNTIME line — superseded as master positioning, but still the ONLY permitted line until Brand master v1.0.2 is ingested and the founder sequences the migration. Never invent an interim replacement.)**                                                                                                                                          |
