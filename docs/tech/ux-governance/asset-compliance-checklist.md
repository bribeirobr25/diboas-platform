...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Logo / wordmark**            | `apps/web/public/assets/logos/logo-light-palette.png`, `logo-dark-palette.png`, `logo-icon.png`; favicon `apps/web/public/favicon.png`. The mark is the **"diBoaS" wordmark whose B is a teal-gradient icon containing a negative-space palm tree**. Casing is exactly **diBoaS** (d-i-B-o-a-S).                                                                                                                                                            |
