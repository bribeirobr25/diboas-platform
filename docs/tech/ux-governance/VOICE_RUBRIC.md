...
> **Footnote (2026-08-29, F-R3):** `BRAND_POSITIONING.md` is SUPERSEDED as **master positioning** (a new Brand direction was ratified; Brand master v1.0.2 ingestion pending). Its **§Voice & Tone → The Writing System remains the operative voice gate** — the deference line above stands unchanged until v1.0.2 is ingested and the founder sequences the migration. No rule in this rubric changes on this footnote alone.
