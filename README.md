...
- **Testing & CI:** strict TypeScript, **2,441 automated tests (Vitest), measured 2026-09-14** across the workspace (web 1,505 · sandbox 724 · banking 105 · investing 66 · defi 41), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
