...
- **Testing & CI:** strict TypeScript, **3,111 tests / 258 files (Vitest), measured 2026-09-22 after the I-G3 shared evidence-lifecycle slice (shared revalidation primitive · four hand-rolled provider caches collapsed to one)** across the workspace (web 1,606/132 · sandbox 1,068/97 · banking 126/5 · investing 86/5 · defi 225/19 — tests/files per package, five per-package runs, none carried; both columns sum to the totals, checked by `review:counts`), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
