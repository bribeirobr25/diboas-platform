...
- **Testing & CI:** strict TypeScript, **2,803 tests / 233 files (Vitest), measured 2026-09-17 after the 5.403 canon realignment (5.410)** across the workspace (web 1,606 · sandbox 928 · banking 118 · investing 86 · defi 65 — five per-package runs, none carried; the components sum to the total), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
