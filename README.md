...
- **Testing & CI:** strict TypeScript, **3,270 tests / 272 files (Vitest), measured 2026-09-24 after S2 of the 5.444 lane (a rate that cannot be stated truthfully is withheld, never zero-filled; its provenance qualifier goes with it)** across the workspace (web 1,606/132 · sandbox 1,117/101 · banking 126/5 · investing 86/5 · defi 335/29 — tests/files per package, five per-package runs, none carried; both columns sum to the totals, checked by `review:counts`), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
