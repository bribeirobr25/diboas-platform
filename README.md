...
- **Testing & CI:** strict TypeScript, **3,252 tests / 269 files (Vitest), measured 2026-09-24 after Blocks E–G of the ratified market-evidence plan (the Practice standard declared in one object; adapter-seam guards; evidence-path observability)** across the workspace (web 1,606/132 · sandbox 1,109/100 · banking 126/5 · investing 86/5 · defi 325/27 — tests/files per package, five per-package runs, none carried; both columns sum to the totals, checked by `review:counts`), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
