...
- **Testing & CI:** strict TypeScript, **2,752 tests / 231 files (Vitest), measured 2026-09-16 at `ac82395c`** across the workspace (web 1,606 · sandbox 892 · banking 109 · investing 86 · defi 59), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
