...
- **Testing & CI:** strict TypeScript, **2,724 tests / 230 files (Vitest), measured 2026-09-16 at `7eda7d16`** across the workspace (web 1,606 · sandbox 872 · banking 109 · investing 78 · defi 59), Lighthouse CI + pa11y (WCAG 2.1 AA), and 6 GitHub Actions workflows (CI, security audit, accessibility, E2E, Lighthouse, quarterly security scan) plus a weekly /market data-refresh workflow.
